              ...
              <div className="relative bg-card p-6 rounded-lg border border-border">
                ...
                <ul className="space-y-3">
                  <li className="flex flex-col md:flex-row md:items-start">
                    <span className="font-semibold md:w-24 mb-1 md:mb-0">Name:</span>
                    <span>Disha Giri</span>
                  </li>
                  <li className="flex flex-col md:flex-row md:items-start">
                    <span className="font-semibold md:w-24 mb-1 md:mb-0">Email:</span>
                    <span className="break-all">disha.career@outlook.com</span>
                  </li>
                  <li className="flex flex-col md:flex-row md:items-start">
                    <span className="font-semibold md:w-24 mb-1 md:mb-0">Location:</span>
                    <span>India</span>
                  </li>
                  <li className="flex flex-col md:flex-row md:items-start">
                    <span className="font-semibold md:w-24 mb-1 md:mb-0">Study:</span>
                    <span>BCA (Bachelor of Computer Applications)</span>
                  </li>
                  <li className="flex flex-col md:flex-row md:items-start">
                    <span className="font-semibold md:w-24 mb-1 md:mb-0">Interests:</span>
